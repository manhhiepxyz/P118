...
class PropertyConnector(Connector):
    ...
    def tool_names(self) -> list[str]:
        # CHỈ `search_properties`. Connector này (port từ nhánh gate2) cũng có
        # implementation cho hai tool kia, nhưng chúng đã do TourConnector và
        # ConsultationConnector đảm nhiệm theo quyết định tái dùng
        # implementation cũ. Khai báo cả ba sẽ tạo hai chủ sở hữu cho cùng một
        # tool, và tool nào thắng phụ thuộc thứ tự đăng ký — im lặng và khó lần.
