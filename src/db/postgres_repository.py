...
class PostgreSQLWorkflowStateRepository:
    ...
    async def list_all_workflows_history(self, page: int = 1, limit: int = 20, search_user: str | None = None, status: str | None = None, date_from: str | None = None, date_to: str | None = None) -> dict:
        return await self.workflows.list_all_workflows_history(page=page, limit=limit, search_user=search_user, status=status, date_from=date_from, date_to=date_to)
