.PHONY: run run-mock run-mock-resident run-mock-transport run-mock-payment gen-test-data test test-mock lint format typecheck check clean
...
# Mock providers độc lập theo system design (3 app, 3 cổng).
# LƯU Ý: run-mock và run-mock-resident đều bind cổng 8001 — 2 lựa chọn thay
# thế, KHÔNG chạy đồng thời. Cổng 8002/8003 tự do.
run-mock-resident:
